...
CV (PDF): [Krzysztof_Blachut_CV.pdf](https://krzysztof-blachut-data.github.io/Krzysztof_Blachut_CV.pdf?v=20260822c)
...
4. **Prognoza płatności** — 50k faktur AR, kto spóźni się ze spłatą, priorytetowa kolejka kontaktu z klientami, [zapytania SQL](projects/payment-forecast/sql/ar_queries.sql). Publiczny sample.
